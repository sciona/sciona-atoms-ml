...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_lars_cv.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "linear_model" / "lars_cv" / "cdg.json"
...
def test_bundle_exists_and_has_lars_cv_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_linear_model_lars_cv.review_bundle.json"
...
def test_manifest_contains_lars_cv_atoms_after_merge() -> None:
