...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_neural_network_mlp_lbfgs_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "neural_network" / "mlp_lbfgs_bookkeeping" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.neural_network.mlp_lbfgs_bookkeeping.mlp_lbfgs_coef_indptr",
    "sciona.atoms.ml.sklearn.neural_network.mlp_lbfgs_bookkeeping.mlp_lbfgs_intercept_indptr",
    "sciona.atoms.ml.sklearn.neural_network.mlp_lbfgs_bookkeeping.mlp_lbfgs_iprint",
    "sciona.atoms.ml.sklearn.neural_network.mlp_lbfgs_bookkeeping.mlp_lbfgs_pack_parameters",
}
...
def test_bundle_exists_and_has_mlp_lbfgs_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_neural_network_mlp_lbfgs_bookkeeping.review_bundle.json"
...
def test_manifest_contains_mlp_lbfgs_bookkeeping_atoms_after_merge() -> None:
