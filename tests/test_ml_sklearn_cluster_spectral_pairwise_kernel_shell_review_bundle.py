...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_spectral_pairwise_kernel_shell.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "spectral_pairwise_kernel_shell" / "cdg.json"
...
def test_bundle_exists_and_has_spectral_pairwise_kernel_shell_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_spectral_pairwise_kernel_shell.review_bundle.json"
