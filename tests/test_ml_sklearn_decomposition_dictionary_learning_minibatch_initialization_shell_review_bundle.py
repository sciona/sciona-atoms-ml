...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_decomposition_dictionary_learning_minibatch_initialization_shell.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "decomposition" / "dictionary_learning_minibatch_initialization_shell" / "cdg.json"
...
def test_bundle_exists_and_has_dictionary_learning_minibatch_initialization_shell_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_decomposition_dictionary_learning_minibatch_initialization_shell.review_bundle.json"
