...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_inspection_partial_dependence_preflight.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "inspection" / "partial_dependence_preflight" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_preflight.partial_dependence_require_no_sample_weight_for_recursion",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_preflight.partial_dependence_require_recursion_support",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_preflight.partial_dependence_require_response_method_auto_for_regressor",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_preflight.partial_dependence_resolve_auto_method",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_preflight.partial_dependence_resolve_kind_method",
}
...
def test_bundle_exists_and_has_partial_dependence_preflight_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_inspection_partial_dependence_preflight.review_bundle.json"
...
def test_manifest_contains_partial_dependence_preflight_atoms_after_merge() -> None:
