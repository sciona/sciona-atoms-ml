...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_inspection_permutation_feature_multimetric_aggregation.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "inspection" / "permutation_feature_multimetric_aggregation" / "cdg.json"
...
def test_bundle_exists_and_has_permutation_feature_multimetric_aggregation_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_inspection_permutation_feature_multimetric_aggregation.review_bundle.json"
