...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_manifold_tsne_fit_shell.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "manifold" / "tsne_fit_shell" / "cdg.json"
...
def test_bundle_exists_and_has_tsne_fit_shell_atom() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_manifold_tsne_fit_shell.review_bundle.json"
