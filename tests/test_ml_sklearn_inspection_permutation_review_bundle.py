...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_inspection_permutation.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "inspection" / "permutation" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.inspection.permutation.permutation_importance_mean",
    "sciona.atoms.ml.sklearn.inspection.permutation.permutation_importance_std",
    "sciona.atoms.ml.sklearn.inspection.permutation.permutation_importance_summary",
    "sciona.atoms.ml.sklearn.inspection.permutation.permutation_importance_values",
}
...
def test_bundle_exists_and_has_permutation_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_inspection_permutation.review_bundle.json"
...
def test_manifest_contains_permutation_atoms_after_merge() -> None:
