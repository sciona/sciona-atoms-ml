...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_feature_selection.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "feature_selection" / "cdg.json"
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_feature_selection.review_bundle.json"
...
def test_manifest_contains_feature_selection_atoms_after_merge() -> None:
