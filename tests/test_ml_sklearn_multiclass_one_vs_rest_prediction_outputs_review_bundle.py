...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_multiclass_one_vs_rest_prediction_outputs.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "multiclass" / "one_vs_rest_prediction_outputs" / "cdg.json"
...
def test_bundle_exists_and_has_one_vs_rest_prediction_output_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_multiclass_one_vs_rest_prediction_outputs.review_bundle.json"
...
def test_manifest_contains_one_vs_rest_prediction_output_atoms_after_merge() -> None:
