...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_ard_regression.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "linear_model" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.linear_model.ard_regression_fit",
    "sciona.atoms.ml.sklearn.linear_model.ard_regression_predict",
    "sciona.atoms.ml.sklearn.linear_model.ard_regression_predict_std",
}
...
def test_bundle_exists_and_has_ard_regression_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_linear_model_ard_regression.review_bundle.json"
...
def test_manifest_contains_ard_regression_atoms_after_merge() -> None:
