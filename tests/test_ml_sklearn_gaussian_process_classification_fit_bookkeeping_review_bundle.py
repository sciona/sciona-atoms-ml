...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_gaussian_process_classification_fit_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "gaussian_process" / "classification_fit_bookkeeping" / "cdg.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.gaussian_process.classification_fit_bookkeeping.gpc_fit_require_not_compound_kernel",
    "sciona.atoms.ml.sklearn.gaussian_process.classification_fit_bookkeeping.gpc_fit_dtype_name",
    "sciona.atoms.ml.sklearn.gaussian_process.classification_fit_bookkeeping.gpc_fit_validate_ensure_2d",
    "sciona.atoms.ml.sklearn.gaussian_process.classification_fit_bookkeeping.gpc_fit_classes",
    "sciona.atoms.ml.sklearn.gaussian_process.classification_fit_bookkeeping.gpc_fit_class_count",
    "sciona.atoms.ml.sklearn.gaussian_process.classification_fit_bookkeeping.gpc_fit_require_multiple_classes",
    "sciona.atoms.ml.sklearn.gaussian_process.classification_fit_bookkeeping.gpc_fit_use_one_vs_rest",
    "sciona.atoms.ml.sklearn.gaussian_process.classification_fit_bookkeeping.gpc_fit_use_one_vs_one",
}
...
def test_bundle_exists_and_has_gpc_fit_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_gaussian_process_classification_fit_bookkeeping.review_bundle.json"
