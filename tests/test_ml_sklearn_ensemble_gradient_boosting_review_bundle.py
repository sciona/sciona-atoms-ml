...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_gradient_boosting.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "gradient_boosting" / "cdg.json"
...
def test_bundle_exists_and_has_gradient_boosting_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_gradient_boosting.review_bundle.json"
...
def test_manifest_contains_gradient_boosting_atoms_after_merge() -> None:
