...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_covariance_robust_fastmcd_1d.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "covariance" / "robust_fastmcd_1d" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_1d.fast_mcd_support_count",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_1d.fast_mcd_1d_location",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_1d.fast_mcd_1d_support_mask",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_1d.fast_mcd_1d_covariance",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_1d.fast_mcd_1d_squared_distances",
}
...
def test_bundle_exists_and_has_robust_fastmcd_1d_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_covariance_robust_fastmcd_1d.review_bundle.json"
...
def test_manifest_contains_robust_fastmcd_1d_atoms_after_merge() -> None:
