...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_local_outlier_factor.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "neighbors" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.neighbors.local_outlier_factor_fit",
    "sciona.atoms.ml.sklearn.neighbors.local_outlier_factor_fit_predict",
    "sciona.atoms.ml.sklearn.neighbors.local_outlier_factor_score_samples",
    "sciona.atoms.ml.sklearn.neighbors.local_outlier_factor_decision_function",
    "sciona.atoms.ml.sklearn.neighbors.local_outlier_factor_predict",
}


def test_local_outlier_factor_review_bundle_exists_and_parses() -> None:
...
def test_local_outlier_factor_review_bundle_rows_are_publishable() -> None:
    bundle = json.loads(BUNDLE_PATH.read_text(encoding="utf-8"))
...
def test_local_outlier_factor_cdg_nodes_have_io_specs() -> None:
...
def test_manifest_contains_local_outlier_factor_atoms_after_merge() -> None:
