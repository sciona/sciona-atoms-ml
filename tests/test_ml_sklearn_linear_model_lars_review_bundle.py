...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_lars.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "linear_model" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.linear_model.lars_path",
    "sciona.atoms.ml.sklearn.linear_model.lars_path_gram",
    "sciona.atoms.ml.sklearn.linear_model.lars_fit",
    "sciona.atoms.ml.sklearn.linear_model.lars_predict",
}
...
def test_bundle_exists_and_has_lars_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_linear_model_lars.review_bundle.json"
...
def test_manifest_contains_lars_atoms_after_merge() -> None:
