...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_metrics_pairwise_kernels.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "metrics_pairwise_kernels" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.metrics_pairwise_kernels.pairwise_default_gamma",
    "sciona.atoms.ml.sklearn.metrics_pairwise_kernels.pairwise_linear_kernel",
    "sciona.atoms.ml.sklearn.metrics_pairwise_kernels.pairwise_polynomial_kernel",
    "sciona.atoms.ml.sklearn.metrics_pairwise_kernels.pairwise_laplacian_kernel",
    "sciona.atoms.ml.sklearn.metrics_pairwise_kernels.pairwise_sigmoid_kernel",
    "sciona.atoms.ml.sklearn.metrics_pairwise_kernels.pairwise_cosine_similarity",
}
...
def test_bundle_exists_and_has_pairwise_kernel_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_metrics_pairwise_kernels.review_bundle.json"
...
def test_manifest_contains_pairwise_kernel_atoms_after_merge() -> None:
