...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_glm.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "linear_model" / "glm" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.linear_model.glm.glm_dense_loss_gradient",
    "sciona.atoms.ml.sklearn.linear_model.glm.glm_linear_raw_prediction",
    "sciona.atoms.ml.sklearn.linear_model.glm.glm_log_link_half_loss_gradient",
}
...
def test_bundle_exists_and_has_glm_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_linear_model_glm.review_bundle.json"
...
def test_manifest_contains_glm_atoms_after_merge() -> None:
