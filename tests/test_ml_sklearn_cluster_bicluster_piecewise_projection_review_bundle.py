...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_bicluster_piecewise_projection.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "bicluster_piecewise_projection" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.cluster.bicluster_piecewise_projection.bicluster_piecewise_vector",
    "sciona.atoms.ml.sklearn.cluster.bicluster_piecewise_projection.bicluster_piecewise_residual_norms",
    "sciona.atoms.ml.sklearn.cluster.bicluster_piecewise_projection.bicluster_select_best_piecewise_vectors",
    "sciona.atoms.ml.sklearn.cluster.bicluster_piecewise_projection.bicluster_project_dense",
}
...
def test_bundle_exists_and_has_bicluster_piecewise_projection_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_bicluster_piecewise_projection.review_bundle.json"
...
def test_manifest_contains_bicluster_piecewise_projection_atoms_after_merge() -> None:
