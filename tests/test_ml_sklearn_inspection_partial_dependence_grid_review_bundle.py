...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_inspection_partial_dependence_grid.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "inspection" / "partial_dependence_grid" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_grid.partial_dependence_feature_axis",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_grid.partial_dependence_grid",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_grid.partial_dependence_grid_parameters",
}
...
def test_bundle_exists_and_has_partial_dependence_grid_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_inspection_partial_dependence_grid.review_bundle.json"
...
def test_manifest_contains_partial_dependence_grid_atoms_after_merge() -> None:
