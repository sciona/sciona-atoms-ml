...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_neighbors_nearest_centroid.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "neighbors" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.neighbors.nearest_centroid_fit",
    "sciona.atoms.ml.sklearn.neighbors.nearest_centroid_predict",
    "sciona.atoms.ml.sklearn.neighbors.nearest_centroid_decision_function",
    "sciona.atoms.ml.sklearn.neighbors.nearest_centroid_predict_log_proba",
    "sciona.atoms.ml.sklearn.neighbors.nearest_centroid_predict_proba",
}


def test_nearest_centroid_review_bundle_exists_and_parses() -> None:
...
def test_nearest_centroid_review_bundle_rows_are_publishable() -> None:
    bundle = json.loads(BUNDLE_PATH.read_text(encoding="utf-8"))
...
def test_nearest_centroid_cdg_nodes_have_io_specs() -> None:
...
def test_manifest_contains_nearest_centroid_atoms_after_merge() -> None:
