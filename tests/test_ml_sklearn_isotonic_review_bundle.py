...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_isotonic.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "isotonic" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.isotonic.isotonic_regression",
    "sciona.atoms.ml.sklearn.isotonic.isotonic_regression_fit",
    "sciona.atoms.ml.sklearn.isotonic.isotonic_regression_transform",
    "sciona.atoms.ml.sklearn.isotonic.isotonic_regression_predict",
}
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_isotonic.review_bundle.json"
...
def test_manifest_contains_isotonic_atoms_after_merge() -> None:
