...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_inspection_partial_dependence_feature_index_guard.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "inspection" / "partial_dependence_feature_index_guard" / "cdg.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_feature_index_guard.partial_dependence_integer_feature_key_type",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_feature_index_guard.partial_dependence_negative_feature_guard_required",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_feature_index_guard.partial_dependence_negative_feature_message",
}
...
def test_bundle_exists_and_has_partial_dependence_feature_index_guard_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_inspection_partial_dependence_feature_index_guard.review_bundle.json"
