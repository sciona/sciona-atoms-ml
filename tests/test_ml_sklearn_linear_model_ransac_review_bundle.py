...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_ransac.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "linear_model" / "ransac" / "cdg.json"
...
def test_bundle_exists_and_has_ransac_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_linear_model_ransac.review_bundle.json"
...
def test_manifest_contains_ransac_atoms_after_merge() -> None:
