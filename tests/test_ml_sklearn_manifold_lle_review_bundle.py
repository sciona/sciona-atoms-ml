...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_manifold_lle.review_bundle.json"
...
def test_lle_review_bundle_exists_and_parses() -> None:
...
def test_lle_review_bundle_rows_are_publishable() -> None:
    bundle = json.loads(BUNDLE_PATH.read_text(encoding="utf-8"))
...
def test_lle_cdg_nodes_have_io_specs() -> None:
...
def test_manifest_contains_lle_atoms_after_merge() -> None:
