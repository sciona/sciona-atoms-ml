...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_neural_network_mlp_early_stopping_state.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "neural_network" / "mlp_early_stopping_state" / "cdg.json"
...
def test_bundle_exists_and_has_mlp_early_stopping_state_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_neural_network_mlp_early_stopping_state.review_bundle.json"
