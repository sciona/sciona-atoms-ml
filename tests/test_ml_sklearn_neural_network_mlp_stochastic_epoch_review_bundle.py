...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_neural_network_mlp_stochastic_epoch.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "neural_network" / "mlp_stochastic_epoch" / "cdg.json"
...
def test_bundle_exists_and_has_mlp_stochastic_epoch_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_neural_network_mlp_stochastic_epoch.review_bundle.json"
...
def test_manifest_contains_mlp_stochastic_epoch_atoms_after_merge() -> None:
