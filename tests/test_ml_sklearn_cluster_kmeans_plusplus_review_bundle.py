...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_kmeans_plusplus.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "kmeans_plusplus" / "cdg.json"
...
def test_bundle_exists_and_has_kmeans_plusplus_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_kmeans_plusplus.review_bundle.json"
...
def test_manifest_contains_kmeans_plusplus_atoms_after_merge() -> None:
