...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_agglomerative.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "agglomerative" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.cluster.agglomerative.agglomerative_root_node",
    "sciona.atoms.ml.sklearn.cluster.agglomerative.agglomerative_descendent_leaves",
    "sciona.atoms.ml.sklearn.cluster.agglomerative.agglomerative_hc_cut",
}
...
def test_bundle_exists_and_has_agglomerative_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_agglomerative.review_bundle.json"
...
def test_manifest_contains_agglomerative_atoms_after_merge() -> None:
