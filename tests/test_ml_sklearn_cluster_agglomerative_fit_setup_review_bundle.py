...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_agglomerative_fit_setup.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "agglomerative_fit_setup" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.cluster.agglomerative_fit_setup.agglomerative_fit_select_tree_builder",
    "sciona.atoms.ml.sklearn.cluster.agglomerative_fit_setup.agglomerative_fit_prepare_connectivity",
}
...
def test_bundle_exists_and_has_agglomerative_fit_setup_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_agglomerative_fit_setup.review_bundle.json"
...
def test_manifest_contains_agglomerative_fit_setup_atoms_after_merge() -> None:
