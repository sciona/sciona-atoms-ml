...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_gaussian_process_classification_log_marginal_likelihood_shell.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "gaussian_process" / "classification_log_marginal_likelihood_shell" / "cdg.json"
...
def test_bundle_exists_and_has_gpc_log_marginal_likelihood_shell_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_gaussian_process_classification_log_marginal_likelihood_shell.review_bundle.json"
