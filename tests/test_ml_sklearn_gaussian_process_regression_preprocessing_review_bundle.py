...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_gaussian_process_regression_preprocessing.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "gaussian_process" / "regression_preprocessing" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.gaussian_process.regression_preprocessing.gp_regression_normalize_targets",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_preprocessing.gp_regression_resolve_alpha",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_preprocessing.gp_regression_target_count",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_preprocessing.gp_regression_target_statistics",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_preprocessing.gp_regression_validate_n_targets",
}
...
def test_bundle_exists_and_has_gp_regression_preprocessing_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_gaussian_process_regression_preprocessing.review_bundle.json"
...
def test_manifest_contains_gp_regression_preprocessing_atoms_after_merge() -> None:
