...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_decomposition_factor_analysis.review_bundle.json"
...
def test_bundle_exists_and_has_factor_analysis_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_decomposition_factor_analysis.review_bundle.json"
...
def test_manifest_contains_factor_analysis_atoms_after_merge() -> None:
