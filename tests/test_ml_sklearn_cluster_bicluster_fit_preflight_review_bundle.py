...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_bicluster_fit_preflight.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "bicluster_fit_preflight" / "cdg.json"
...
def test_bundle_exists_and_has_bicluster_fit_preflight_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_bicluster_fit_preflight.review_bundle.json"
