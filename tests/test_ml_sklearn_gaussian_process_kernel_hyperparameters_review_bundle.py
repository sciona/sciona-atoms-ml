...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_gaussian_process_kernel_hyperparameters.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "gaussian_process" / "kernel_hyperparameters" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.gaussian_process.kernel_hyperparameters.gp_kernel_theta",
    "sciona.atoms.ml.sklearn.gaussian_process.kernel_hyperparameters.gp_kernel_values_from_theta",
    "sciona.atoms.ml.sklearn.gaussian_process.kernel_hyperparameters.gp_kernel_bounds",
    "sciona.atoms.ml.sklearn.gaussian_process.kernel_hyperparameters.gp_kernel_bound_warning_records",
}
...
def test_bundle_exists_and_has_gp_kernel_hyperparameters_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_gaussian_process_kernel_hyperparameters.review_bundle.json"
...
def test_manifest_contains_gp_kernel_hyperparameters_atoms_after_merge() -> None:
