...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_bagging_index_reconstruction.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "bagging_index_reconstruction" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.bagging_index_reconstruction.bagging_estimator_index_pairs",
    "sciona.atoms.ml.sklearn.ensemble.bagging_index_reconstruction.bagging_estimators_feature_indices",
    "sciona.atoms.ml.sklearn.ensemble.bagging_index_reconstruction.bagging_estimators_sample_indices",
}
...
def test_bundle_exists_and_has_bagging_index_reconstruction_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_bagging_index_reconstruction.review_bundle.json"
...
def test_manifest_contains_bagging_index_reconstruction_atoms_after_merge() -> None:
