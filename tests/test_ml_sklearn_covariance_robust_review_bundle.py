...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_covariance_robust.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "covariance" / "robust" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.covariance.robust.mcd_consistency_factor",
    "sciona.atoms.ml.sklearn.covariance.robust.mcd_correct_covariance",
    "sciona.atoms.ml.sklearn.covariance.robust.mcd_reweight_support_mask",
    "sciona.atoms.ml.sklearn.covariance.robust.mcd_reweighted_location_covariance",
    "sciona.atoms.ml.sklearn.covariance.robust.mcd_squared_mahalanobis",
}
...
def test_bundle_exists_and_has_robust_covariance_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_covariance_robust.review_bundle.json"
...
def test_manifest_contains_robust_covariance_atoms_after_merge() -> None:
