...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_bagging_classifier_io.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "bagging_classifier_io" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.bagging_classifier_io.bagging_classifier_fit_targets",
    "sciona.atoms.ml.sklearn.ensemble.bagging_classifier_io.bagging_classifier_labels_from_probabilities",
}
...
def test_bundle_exists_and_has_bagging_classifier_io_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_bagging_classifier_io.review_bundle.json"
...
def test_manifest_contains_bagging_classifier_io_atoms_after_merge() -> None:
