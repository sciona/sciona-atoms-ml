...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_bagging_oob_scoring.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "bagging_oob_scoring" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.bagging_oob_scoring.bagging_oob_uncovered_mask",
    "sciona.atoms.ml.sklearn.ensemble.bagging_oob_scoring.bagging_classifier_oob_accuracy",
    "sciona.atoms.ml.sklearn.ensemble.bagging_oob_scoring.bagging_regressor_oob_r2",
}
...
def test_bundle_exists_and_has_bagging_oob_scoring_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_bagging_oob_scoring.review_bundle.json"
...
def test_manifest_contains_bagging_oob_scoring_atoms_after_merge() -> None:
