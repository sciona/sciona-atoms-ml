...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_gaussian_process_regression_prior_prediction.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "gaussian_process" / "regression_prior_prediction" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.gaussian_process.regression_prior_prediction.gp_regression_prior_covariance",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_prior_prediction.gp_regression_prior_mean",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_prior_prediction.gp_regression_prior_std",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_prior_prediction.gp_regression_prior_target_count",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_prior_prediction.gp_regression_prior_variance",
}
...
def test_bundle_exists_and_has_gp_regression_prior_prediction_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_gaussian_process_regression_prior_prediction.review_bundle.json"
...
def test_manifest_contains_gp_regression_prior_prediction_atoms_after_merge() -> None:
