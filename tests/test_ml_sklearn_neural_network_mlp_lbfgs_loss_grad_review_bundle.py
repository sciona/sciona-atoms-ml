...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_neural_network_mlp_lbfgs_loss_grad.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "neural_network" / "mlp_lbfgs_loss_grad" / "cdg.json"
...
def test_bundle_exists_and_has_mlp_lbfgs_loss_grad_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_neural_network_mlp_lbfgs_loss_grad.review_bundle.json"
