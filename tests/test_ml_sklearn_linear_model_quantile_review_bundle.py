...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_quantile.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "linear_model" / "quantile" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.linear_model.quantile.quantile_dense_lp_problem",
    "sciona.atoms.ml.sklearn.linear_model.quantile.quantile_nonzero_weight_mask",
    "sciona.atoms.ml.sklearn.linear_model.quantile.quantile_solution_to_params",
}
...
def test_bundle_exists_and_has_quantile_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_linear_model_quantile.review_bundle.json"
...
def test_manifest_contains_quantile_atoms_after_merge() -> None:
