...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_feature_selection_select_from_model_postfit_attributes.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "feature_selection" / "select_from_model_postfit_attributes" / "cdg.json"
...
def test_bundle_exists_and_has_select_from_model_postfit_attributes_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_feature_selection_select_from_model_postfit_attributes.review_bundle.json"
