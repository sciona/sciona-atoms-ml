...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_sgd.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "linear_model" / "sgd" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.linear_model.sgd.passive_aggressive_classifier_sgd_config",
    "sciona.atoms.ml.sklearn.linear_model.sgd.passive_aggressive_regressor_sgd_config",
    "sciona.atoms.ml.sklearn.linear_model.sgd.sgd_l1_ratio_or_zero",
    "sciona.atoms.ml.sklearn.linear_model.sgd.sgd_learning_rate_value",
    "sciona.atoms.ml.sklearn.linear_model.sgd.sgd_modified_huber_proba",
    "sciona.atoms.ml.sklearn.linear_model.sgd.sgd_passive_aggressive_step_size",
}
...
def test_bundle_exists_and_has_sgd_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_linear_model_sgd.review_bundle.json"
...
def test_manifest_contains_sgd_atoms_after_merge() -> None:
