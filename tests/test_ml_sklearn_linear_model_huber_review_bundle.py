...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_huber.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "linear_model" / "huber" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.linear_model.huber.huber_linear_residuals",
    "sciona.atoms.ml.sklearn.linear_model.huber.huber_loss_gradient",
    "sciona.atoms.ml.sklearn.linear_model.huber.huber_outlier_mask",
}
...
def test_bundle_exists_and_has_huber_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_linear_model_huber.review_bundle.json"
...
def test_manifest_contains_huber_atoms_after_merge() -> None:
