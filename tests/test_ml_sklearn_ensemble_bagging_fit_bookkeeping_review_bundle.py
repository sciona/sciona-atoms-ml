...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_bagging_fit_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "bagging_fit_bookkeeping" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.bagging_fit_bookkeeping.bagging_resolve_max_samples",
    "sciona.atoms.ml.sklearn.ensemble.bagging_fit_bookkeeping.bagging_resolve_max_features",
    "sciona.atoms.ml.sklearn.ensemble.bagging_fit_bookkeeping.bagging_fit_require_bootstrap_for_oob",
    "sciona.atoms.ml.sklearn.ensemble.bagging_fit_bookkeeping.bagging_fit_require_no_warm_start_with_oob",
    "sciona.atoms.ml.sklearn.ensemble.bagging_fit_bookkeeping.bagging_additional_estimator_count",
}
...
def test_bundle_exists_and_has_bagging_fit_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_bagging_fit_bookkeeping.review_bundle.json"
...
def test_manifest_contains_bagging_fit_bookkeeping_atoms_after_merge() -> None:
