...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_forest_fit_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "forest_fit_bookkeeping" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.forest_fit_bookkeeping.forest_fit_bootstrap_sample_count",
    "sciona.atoms.ml.sklearn.ensemble.forest_fit_bookkeeping.forest_fit_require_bootstrap_for_oob",
    "sciona.atoms.ml.sklearn.ensemble.forest_fit_bookkeeping.forest_fit_additional_estimator_count",
    "sciona.atoms.ml.sklearn.ensemble.forest_fit_bookkeeping.forest_fit_oob_update_required",
    "sciona.atoms.ml.sklearn.ensemble.forest_fit_bookkeeping.forest_fit_require_supported_oob_target_type",
}
...
def test_bundle_exists_and_has_forest_fit_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_forest_fit_bookkeeping.review_bundle.json"
...
def test_manifest_contains_forest_fit_bookkeeping_atoms_after_merge() -> None:
