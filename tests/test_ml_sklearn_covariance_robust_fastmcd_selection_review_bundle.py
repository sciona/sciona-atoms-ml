...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_covariance_robust_fastmcd_selection.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "covariance" / "robust_fastmcd_selection" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_selection.fast_mcd_trial_plan",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_selection.fast_mcd_best_candidate_indices",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_selection.fast_mcd_gather_best_candidates",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_selection.fast_mcd_large_sample_schedule",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_selection.fast_mcd_place_merged_results",
}
...
def test_bundle_exists_and_has_robust_fastmcd_selection_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_covariance_robust_fastmcd_selection.review_bundle.json"
...
def test_manifest_contains_robust_fastmcd_selection_atoms_after_merge() -> None:
