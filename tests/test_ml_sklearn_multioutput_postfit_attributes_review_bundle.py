...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_multioutput_postfit_attributes.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "multioutput" / "postfit_attributes" / "cdg.json"
...
def test_bundle_exists_and_has_multioutput_postfit_attributes_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_multioutput_postfit_attributes.review_bundle.json"
