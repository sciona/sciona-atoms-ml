...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_gaussian_process_regression_optimizer_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "gaussian_process" / "regression_optimizer_bookkeeping" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.gaussian_process.regression_optimizer_bookkeeping.gp_regression_restart_bounds",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_optimizer_bookkeeping.gp_regression_restart_thetas",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_optimizer_bookkeeping.gp_regression_select_best_optimum",
}
...
def test_bundle_exists_and_has_gp_regression_optimizer_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_gaussian_process_regression_optimizer_bookkeeping.review_bundle.json"
...
def test_manifest_contains_gp_regression_optimizer_bookkeeping_atoms_after_merge() -> None:
