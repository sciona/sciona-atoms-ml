...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_feature_selection_sequential_fit_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "feature_selection" / "sequential_fit_bookkeeping" / "cdg.json"
...
def test_bundle_exists_and_has_sequential_fit_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_feature_selection_sequential_fit_bookkeeping.review_bundle.json"
...
def test_manifest_contains_sequential_fit_bookkeeping_atoms_after_merge() -> None:
