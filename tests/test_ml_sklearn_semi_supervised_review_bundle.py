...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_semi_supervised.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "semi_supervised" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.semi_supervised.label_propagation_fit",
    "sciona.atoms.ml.sklearn.semi_supervised.label_propagation_predict",
    "sciona.atoms.ml.sklearn.semi_supervised.label_propagation_predict_proba",
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_semi_supervised.review_bundle.json"
...
def test_manifest_contains_semi_supervised_atoms_after_merge() -> None:
