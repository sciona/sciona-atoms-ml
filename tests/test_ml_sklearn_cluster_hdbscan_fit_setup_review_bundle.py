...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_hdbscan_fit_setup.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "hdbscan_fit_setup" / "cdg.json"
...
def test_bundle_exists_and_has_hdbscan_fit_setup_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_hdbscan_fit_setup.review_bundle.json"
