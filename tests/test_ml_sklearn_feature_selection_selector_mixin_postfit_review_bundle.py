...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_feature_selection_selector_mixin_postfit.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "feature_selection" / "selector_mixin_postfit" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.feature_selection.selector_mixin_postfit.selector_support_indices",
    "sciona.atoms.ml.sklearn.feature_selection.selector_mixin_postfit.selector_transform_dense",
    "sciona.atoms.ml.sklearn.feature_selection.selector_mixin_postfit.selector_inverse_transform_dense",
    "sciona.atoms.ml.sklearn.feature_selection.selector_mixin_postfit.selector_feature_names_out",
}
...
def test_bundle_exists_and_has_selector_mixin_postfit_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_feature_selection_selector_mixin_postfit.review_bundle.json"
...
def test_manifest_contains_selector_mixin_postfit_atoms_after_merge() -> None:
