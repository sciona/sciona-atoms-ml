...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_multiclass_one_vs_rest_targets.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "multiclass" / "one_vs_rest_targets" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.multiclass.one_vs_rest_targets.one_vs_rest_fit_classes",
    "sciona.atoms.ml.sklearn.multiclass.one_vs_rest_targets.one_vs_rest_fit_target_indicator_csc",
    "sciona.atoms.ml.sklearn.multiclass.one_vs_rest_targets.one_vs_rest_partial_fit_unknown_classes",
    "sciona.atoms.ml.sklearn.multiclass.one_vs_rest_targets.one_vs_rest_partial_fit_target_indicator_csc",
    "sciona.atoms.ml.sklearn.multiclass.one_vs_rest_targets.one_vs_rest_target_columns_dense",
}
...
def test_bundle_exists_and_has_multiclass_one_vs_rest_targets_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_multiclass_one_vs_rest_targets.review_bundle.json"
...
def test_manifest_contains_multiclass_one_vs_rest_targets_atoms_after_merge() -> None:
