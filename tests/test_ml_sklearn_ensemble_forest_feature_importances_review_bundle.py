...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_forest_feature_importances.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "forest_feature_importances" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.forest_feature_importances.forest_importance_contributor_mask",
    "sciona.atoms.ml.sklearn.ensemble.forest_feature_importances.forest_zero_feature_importances",
    "sciona.atoms.ml.sklearn.ensemble.forest_feature_importances.forest_average_feature_importances",
    "sciona.atoms.ml.sklearn.ensemble.forest_feature_importances.forest_normalized_feature_importances",
}
...
def test_bundle_exists_and_has_forest_feature_importances_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_forest_feature_importances.review_bundle.json"
...
def test_manifest_contains_forest_feature_importances_atoms_after_merge() -> None:
