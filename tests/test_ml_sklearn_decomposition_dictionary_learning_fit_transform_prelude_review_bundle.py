...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_decomposition_dictionary_learning_fit_transform_prelude.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "decomposition" / "dictionary_learning_fit_transform_prelude" / "cdg.json"
...
def test_bundle_exists_and_has_dictionary_learning_fit_transform_prelude_atoms() -> None:
...
def test_bundle_matches_cdg_family() -> None:
    ...
    assert cdg["module"] == "sciona.atoms.ml.sklearn.decomposition.dictionary_learning_fit_transform_prelude"
    assert bundle["family_batch"] == "ml_sklearn_decomposition_dictionary_learning_fit_transform_prelude"
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_decomposition_dictionary_learning_fit_transform_prelude.review_bundle.json"
