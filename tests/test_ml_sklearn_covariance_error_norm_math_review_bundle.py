...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_covariance_error_norm_math.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "covariance" / "error_norm_math" / "cdg.json"
...
def test_bundle_exists_and_has_covariance_error_norm_math_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_covariance_error_norm_math.review_bundle.json"
