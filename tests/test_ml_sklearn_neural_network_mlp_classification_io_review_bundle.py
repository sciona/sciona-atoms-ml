...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_neural_network_mlp_classification_io.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "neural_network" / "mlp_classification_io" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.neural_network.mlp_classification_io.mlp_classifier_fit_target_state",
    "sciona.atoms.ml.sklearn.neural_network.mlp_classification_io.mlp_classifier_partial_fit_target_state",
    "sciona.atoms.ml.sklearn.neural_network.mlp_classification_io.mlp_classifier_encode_targets",
    "sciona.atoms.ml.sklearn.neural_network.mlp_classification_io.mlp_classifier_labels_from_outputs",
    "sciona.atoms.ml.sklearn.neural_network.mlp_classification_io.mlp_classifier_probabilities_from_outputs",
}
...
def test_bundle_exists_and_has_mlp_classification_io_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_neural_network_mlp_classification_io.review_bundle.json"
...
def test_manifest_contains_mlp_classification_io_atoms_after_merge() -> None:
