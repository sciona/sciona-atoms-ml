...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_theil_sen.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "linear_model" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.linear_model.theil_sen_regressor_fit",
    "sciona.atoms.ml.sklearn.linear_model.theil_sen_regressor_predict",
}
...
def test_bundle_exists_and_has_theil_sen_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_linear_model_theil_sen.review_bundle.json"
...
def test_manifest_contains_theil_sen_atoms_after_merge() -> None:
