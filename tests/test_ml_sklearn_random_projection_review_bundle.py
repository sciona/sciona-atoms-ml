...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_random_projection.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "random_projection" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.random_projection.gaussian_random_projection_fit",
    "sciona.atoms.ml.sklearn.random_projection.gaussian_random_projection_transform",
    "sciona.atoms.ml.sklearn.random_projection.sparse_random_projection_fit",
    "sciona.atoms.ml.sklearn.random_projection.sparse_random_projection_transform",
    "sciona.atoms.ml.sklearn.random_projection.random_projection_inverse_transform",
}
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_random_projection.review_bundle.json"
...
def test_manifest_contains_random_projection_atoms_after_merge() -> None:
