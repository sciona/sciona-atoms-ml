...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_feature_selection_selector_mixin_sparse_transform.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "feature_selection" / "selector_mixin_sparse_transform" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.feature_selection.selector_mixin_sparse_transform.selector_transform_sparse",
}
...
def test_bundle_exists_and_has_selector_mixin_sparse_transform_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_feature_selection_selector_mixin_sparse_transform.review_bundle.json"
...
def test_manifest_contains_selector_mixin_sparse_transform_atoms_after_merge() -> None:
