...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_stacking_meta_features.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "stacking_meta_features" / "cdg.json"
...
def test_bundle_exists_and_has_stacking_meta_features_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_stacking_meta_features.review_bundle.json"
...
def test_manifest_contains_stacking_meta_features_atoms_after_merge() -> None:
