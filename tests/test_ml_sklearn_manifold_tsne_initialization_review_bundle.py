...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_manifold_tsne_initialization.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "manifold" / "tsne_initialization" / "cdg.json"
...
def test_bundle_exists_and_has_tsne_initialization_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_manifold_tsne_initialization.review_bundle.json"
...
def test_manifest_contains_tsne_initialization_atoms_after_merge() -> None:
