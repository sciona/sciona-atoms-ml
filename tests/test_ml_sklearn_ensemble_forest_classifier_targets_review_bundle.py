...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_forest_classifier_targets.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "forest_classifier_targets" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.forest_classifier_targets.forest_classifier_fit_targets",
    "sciona.atoms.ml.sklearn.ensemble.forest_classifier_targets.forest_classifier_validate_class_weight_preset",
    "sciona.atoms.ml.sklearn.ensemble.forest_classifier_targets.forest_classifier_class_weight_warning_required",
    "sciona.atoms.ml.sklearn.ensemble.forest_classifier_targets.forest_classifier_expanded_class_weight",
}
...
def test_bundle_exists_and_has_forest_classifier_targets_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_forest_classifier_targets.review_bundle.json"
...
def test_manifest_contains_forest_classifier_targets_atoms_after_merge() -> None:
