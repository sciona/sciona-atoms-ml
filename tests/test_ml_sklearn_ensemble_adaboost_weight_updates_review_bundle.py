...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_adaboost_weight_updates.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "adaboost_weight_updates" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.adaboost_weight_updates.adaboost_classifier_estimator_error",
    "sciona.atoms.ml.sklearn.ensemble.adaboost_weight_updates.adaboost_classifier_estimator_weight",
    "sciona.atoms.ml.sklearn.ensemble.adaboost_weight_updates.adaboost_classifier_sample_weight_update",
    "sciona.atoms.ml.sklearn.ensemble.adaboost_weight_updates.adaboost_regressor_loss_vector",
    "sciona.atoms.ml.sklearn.ensemble.adaboost_weight_updates.adaboost_regressor_estimator_error",
    "sciona.atoms.ml.sklearn.ensemble.adaboost_weight_updates.adaboost_regressor_beta",
    "sciona.atoms.ml.sklearn.ensemble.adaboost_weight_updates.adaboost_regressor_estimator_weight",
    "sciona.atoms.ml.sklearn.ensemble.adaboost_weight_updates.adaboost_regressor_sample_weight_update",
}
...
def test_bundle_exists_and_has_adaboost_weight_update_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_adaboost_weight_updates.review_bundle.json"
...
def test_manifest_contains_adaboost_weight_update_atoms_after_merge() -> None:
