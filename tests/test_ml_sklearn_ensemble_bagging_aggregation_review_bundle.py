...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_bagging_aggregation.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "bagging_aggregation" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.bagging_aggregation.bagging_classifier_average_probabilities",
    "sciona.atoms.ml.sklearn.ensemble.bagging_aggregation.bagging_classifier_average_log_probabilities",
    "sciona.atoms.ml.sklearn.ensemble.bagging_aggregation.bagging_classifier_average_decision_function",
    "sciona.atoms.ml.sklearn.ensemble.bagging_aggregation.bagging_regressor_average_predictions",
}
...
def test_bundle_exists_and_has_bagging_aggregation_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_bagging_aggregation.review_bundle.json"
...
def test_manifest_contains_bagging_aggregation_atoms_after_merge() -> None:
