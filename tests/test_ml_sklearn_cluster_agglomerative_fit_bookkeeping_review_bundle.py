...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_agglomerative_fit_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "agglomerative_fit_bookkeeping" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.cluster.agglomerative_fit_bookkeeping.agglomerative_resolve_compute_full_tree",
    "sciona.atoms.ml.sklearn.cluster.agglomerative_fit_bookkeeping.agglomerative_resolve_tree_n_clusters",
    "sciona.atoms.ml.sklearn.cluster.agglomerative_fit_bookkeeping.agglomerative_return_distance_required",
    "sciona.atoms.ml.sklearn.cluster.agglomerative_fit_bookkeeping.agglomerative_cluster_count_from_distances",
    "sciona.atoms.ml.sklearn.cluster.agglomerative_fit_bookkeeping.agglomerative_labels_from_heads",
}
...
def test_bundle_exists_and_has_agglomerative_fit_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_agglomerative_fit_bookkeeping.review_bundle.json"
...
def test_manifest_contains_agglomerative_fit_bookkeeping_atoms_after_merge() -> None:
