...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_neighbors_graph.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "neighbors" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.neighbors.kneighbors_graph",
    "sciona.atoms.ml.sklearn.neighbors.radius_neighbors_graph",
    "sciona.atoms.ml.sklearn.neighbors.kneighbors_transformer_fit",
    "sciona.atoms.ml.sklearn.neighbors.kneighbors_transform",
    "sciona.atoms.ml.sklearn.neighbors.radius_neighbors_transformer_fit",
    "sciona.atoms.ml.sklearn.neighbors.radius_neighbors_transform",
}


def test_neighbors_graph_review_bundle_exists_and_parses() -> None:
...
def test_neighbors_graph_review_bundle_rows_are_publishable() -> None:
    bundle = json.loads(BUNDLE_PATH.read_text(encoding="utf-8"))
...
def test_neighbors_graph_cdg_nodes_have_io_specs() -> None:
...
def test_manifest_contains_neighbors_graph_atoms_after_merge() -> None:
