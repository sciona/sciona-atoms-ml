...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_forest_classifier_outputs.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "forest_classifier_outputs" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.forest_classifier_outputs.forest_classifier_log_probability_matrix",
    "sciona.atoms.ml.sklearn.ensemble.forest_classifier_outputs.forest_classifier_log_probability_blocks",
    "sciona.atoms.ml.sklearn.ensemble.forest_classifier_outputs.forest_classifier_multioutput_labels",
}
...
def test_bundle_exists_and_has_forest_classifier_output_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_forest_classifier_outputs.review_bundle.json"
...
def test_manifest_contains_forest_classifier_output_atoms_after_merge() -> None:
