...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_decomposition_fastica.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "decomposition" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.decomposition.fastica_fit",
    "sciona.atoms.ml.sklearn.decomposition.fastica_transform",
    "sciona.atoms.ml.sklearn.decomposition.fastica_inverse_transform",
}
...
def test_bundle_exists_and_has_fastica_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_decomposition_fastica.review_bundle.json"
...
def test_manifest_contains_fastica_atoms_after_merge() -> None:
