...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_covariance_robust_fastmcd_c_step.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "covariance" / "robust_fastmcd_c_step" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_c_step.fast_mcd_initial_random_support_indices",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_c_step.fast_mcd_support_indices_from_estimates",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_c_step.fast_mcd_support_statistics",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_c_step.fast_mcd_c_step",
}
...
def test_bundle_exists_and_has_fastmcd_c_step_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_covariance_robust_fastmcd_c_step.review_bundle.json"
...
def test_manifest_contains_fastmcd_c_step_atoms_after_merge() -> None:
