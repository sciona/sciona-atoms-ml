...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_inspection_partial_dependence_postprocessing.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "inspection" / "partial_dependence_postprocessing" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_postprocessing.partial_dependence_assign_grid_values",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_postprocessing.partial_dependence_average_response_sequence",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_postprocessing.partial_dependence_finalize_averages",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_postprocessing.partial_dependence_finalize_predictions",
    "sciona.atoms.ml.sklearn.inspection.partial_dependence_postprocessing.partial_dependence_stack_response_sequence",
}
...
def test_bundle_exists_and_has_partial_dependence_postprocessing_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_inspection_partial_dependence_postprocessing.review_bundle.json"
...
def test_manifest_contains_partial_dependence_postprocessing_atoms_after_merge() -> None:
