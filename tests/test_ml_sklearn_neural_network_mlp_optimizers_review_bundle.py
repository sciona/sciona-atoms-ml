...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_neural_network_mlp_optimizers.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "neural_network" / "mlp_optimizers" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.neural_network.mlp_optimizers.mlp_sgd_initialize_state",
    "sciona.atoms.ml.sklearn.neural_network.mlp_optimizers.mlp_sgd_updates",
    "sciona.atoms.ml.sklearn.neural_network.mlp_optimizers.mlp_sgd_iteration_end",
    "sciona.atoms.ml.sklearn.neural_network.mlp_optimizers.mlp_sgd_trigger_stopping",
    "sciona.atoms.ml.sklearn.neural_network.mlp_optimizers.mlp_adam_initialize_state",
    "sciona.atoms.ml.sklearn.neural_network.mlp_optimizers.mlp_adam_updates",
}
...
def test_bundle_exists_and_has_mlp_optimizer_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_neural_network_mlp_optimizers.review_bundle.json"
...
def test_manifest_contains_mlp_optimizer_atoms_after_merge() -> None:
