...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_gaussian_process_classification_kernel_shell.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "gaussian_process" / "classification_kernel_shell" / "cdg.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.gaussian_process.classification_kernel_shell.gpc_kernel_use_binary_branch",
    "sciona.atoms.ml.sklearn.gaussian_process.classification_kernel_shell.gpc_kernel_result",
}
...
def test_bundle_exists_and_has_gpc_kernel_shell_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_gaussian_process_classification_kernel_shell.review_bundle.json"
