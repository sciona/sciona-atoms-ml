...
def test_sgd_regressor_fit_callback_shell_references_cover_registered_atoms() -> None:
...
def test_sgd_regressor_fit_callback_shell_references_have_source_and_project_refs() -> None:
    references = json.loads((FAMILY_DIR / "references.json").read_text())
