...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_variance_threshold.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "variance_threshold" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.variance_threshold.variance_threshold_fit",
    "sciona.atoms.ml.sklearn.variance_threshold.variance_threshold_support_mask",
    "sciona.atoms.ml.sklearn.variance_threshold.variance_threshold_transform",
}
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_variance_threshold.review_bundle.json"
...
def test_manifest_contains_variance_threshold_atoms_after_merge() -> None:
