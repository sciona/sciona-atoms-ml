...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_cocluster_fit_preflight.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "cocluster_fit_preflight" / "cdg.json"
...
def test_bundle_exists_and_has_cocluster_fit_preflight_atom() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_cocluster_fit_preflight.review_bundle.json"
