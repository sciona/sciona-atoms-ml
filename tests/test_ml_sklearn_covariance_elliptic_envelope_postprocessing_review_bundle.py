...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_covariance_elliptic_envelope_postprocessing.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "covariance" / "elliptic_envelope_postprocessing" / "cdg.json"
...
def test_bundle_exists_and_has_elliptic_envelope_postprocessing_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_covariance_elliptic_envelope_postprocessing.review_bundle.json"
