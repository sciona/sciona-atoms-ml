...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_bagging_fit_scheduling.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "bagging_fit_scheduling" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.bagging_fit_scheduling.bagging_partition_estimators",
    "sciona.atoms.ml.sklearn.ensemble.bagging_fit_scheduling.bagging_fit_seeds",
}
...
def test_bundle_exists_and_has_bagging_fit_scheduling_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_bagging_fit_scheduling.review_bundle.json"
...
def test_manifest_contains_bagging_fit_scheduling_atoms_after_merge() -> None:
