...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_tree_missing_value_mask_outputs.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "tree" / "missing_value_mask_outputs" / "cdg.json"
...
def test_bundle_exists_and_has_tree_missing_value_mask_outputs_atoms() -> None:
    bundle = json.loads(BUNDLE_PATH.read_text())
    assert bundle["bundle_id"] == "sciona.atoms.review_bundle.ml.sklearn_tree_missing_value_mask_outputs.v1"
    assert bundle["family_batch"] == "ml_sklearn_tree_missing_value_mask_outputs"
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_tree_missing_value_mask_outputs.review_bundle.json"
