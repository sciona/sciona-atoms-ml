...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_forest_oob_predictions.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "forest_oob_predictions" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.forest_oob_predictions.forest_classifier_oob_prediction_block",
    "sciona.atoms.ml.sklearn.ensemble.forest_oob_predictions.forest_regressor_oob_prediction_block",
    "sciona.atoms.ml.sklearn.ensemble.forest_oob_predictions.forest_oob_prediction_totals",
    "sciona.atoms.ml.sklearn.ensemble.forest_oob_predictions.forest_oob_prediction_counts",
    "sciona.atoms.ml.sklearn.ensemble.forest_oob_predictions.forest_oob_uncovered_mask",
    "sciona.atoms.ml.sklearn.ensemble.forest_oob_predictions.forest_oob_average_predictions",
}
...
def test_bundle_exists_and_has_forest_oob_prediction_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_forest_oob_predictions.review_bundle.json"
...
def test_manifest_contains_forest_oob_prediction_atoms_after_merge() -> None:
