...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_multioutput_chain_prediction_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "multioutput" / "chain_prediction_bookkeeping" / "cdg.json"
...
def test_bundle_exists_and_has_chain_prediction_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_multioutput_chain_prediction_bookkeeping.review_bundle.json"
...
def test_manifest_contains_chain_prediction_bookkeeping_atoms_after_merge() -> None:
