...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_neighbors_nca.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "neighbors" / "nca" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.neighbors.nca.nca_linear_transform",
    "sciona.atoms.ml.sklearn.neighbors.nca.nca_loss_gradient",
    "sciona.atoms.ml.sklearn.neighbors.nca.nca_neighbor_probabilities",
    "sciona.atoms.ml.sklearn.neighbors.nca.nca_same_class_mask",
}
...
def test_bundle_exists_and_has_nca_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_neighbors_nca.review_bundle.json"
...
def test_manifest_contains_nca_atoms_after_merge() -> None:
