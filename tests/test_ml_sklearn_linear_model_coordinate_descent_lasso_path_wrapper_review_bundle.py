...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_coordinate_descent_lasso_path_wrapper.review_bundle.json"
CDG_PATH = (
    ROOT
    / "src"
    / "sciona"
...
def test_bundle_exists_and_has_coordinate_descent_lasso_path_wrapper_atoms() -> None:
    bundle = json.loads(BUNDLE_PATH.read_text())
    assert bundle["bundle_id"] == "sciona.atoms.review_bundle.ml.sklearn_linear_model_coordinate_descent_lasso_path_wrapper.v1"
    assert bundle["family_batch"] == "ml_sklearn_linear_model_coordinate_descent_lasso_path_wrapper"
    ...
    assert (
        ...
        == "data/review_bundles/ml_sklearn_linear_model_coordinate_descent_lasso_path_wrapper.review_bundle.json"
    )
