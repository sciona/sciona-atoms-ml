...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_neighbors_classifier.review_bundle.json"
...
def test_neighbors_classifier_review_bundle_exists_and_parses() -> None:
...
def test_neighbors_classifier_review_bundle_rows_are_publishable() -> None:
    bundle = json.loads(BUNDLE_PATH.read_text(encoding="utf-8"))
...
def test_neighbors_classifier_cdg_nodes_have_io_specs() -> None:
...
def test_manifest_contains_neighbors_classifier_atoms_after_merge() -> None:
