...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_feature_extraction_feature_hasher_shell.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "feature_extraction" / "feature_hasher_shell" / "cdg.json"
...
def test_bundle_exists_and_has_feature_hasher_shell_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_feature_extraction_feature_hasher_shell.review_bundle.json"
