...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_multiclass_one_vs_one_fit_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "multiclass" / "one_vs_one_fit_bookkeeping" / "cdg.json"
...
def test_bundle_exists_and_has_one_vs_one_fit_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_multiclass_one_vs_one_fit_bookkeeping.review_bundle.json"
