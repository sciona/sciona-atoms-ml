...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_feature_selection_select_from_model_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "feature_selection" / "select_from_model_bookkeeping" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.feature_selection.select_from_model_bookkeeping.select_from_model_checked_max_features",
    "sciona.atoms.ml.sklearn.feature_selection.select_from_model_bookkeeping.select_from_model_prefit_estimator_valid",
    "sciona.atoms.ml.sklearn.feature_selection.select_from_model_bookkeeping.select_from_model_prefit_callable_max_features_ready",
    "sciona.atoms.ml.sklearn.feature_selection.select_from_model_bookkeeping.select_from_model_candidate_indices",
}
...
def test_bundle_exists_and_has_select_from_model_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_feature_selection_select_from_model_bookkeeping.review_bundle.json"
...
def test_manifest_contains_select_from_model_bookkeeping_atoms_after_merge() -> None:
