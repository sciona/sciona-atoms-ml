...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_model_selection_recommendations.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "model_selection" / "recommendations" / "cdg.json"
...
def test_bundle_exists_and_has_recommendation_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_model_selection_recommendations.review_bundle.json"
