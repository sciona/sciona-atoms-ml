...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_stacking_classifier_outputs.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "stacking_classifier_outputs" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.stacking_classifier_outputs.stacking_classifier_labels_from_encoded",
    "sciona.atoms.ml.sklearn.ensemble.stacking_classifier_outputs.stacking_classifier_multilabel_labels_from_encoded",
    "sciona.atoms.ml.sklearn.ensemble.stacking_classifier_outputs.stacking_classifier_probability_matrix_from_blocks",
}
...
def test_bundle_exists_and_has_stacking_classifier_outputs_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_stacking_classifier_outputs.review_bundle.json"
...
def test_manifest_contains_stacking_classifier_outputs_atoms_after_merge() -> None:
