...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_multioutput_response_method_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "multioutput" / "response_method_bookkeeping" / "cdg.json"
...
def test_bundle_exists_and_has_multioutput_response_method_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_multioutput_response_method_bookkeeping.review_bundle.json"
