...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_multiclass_one_vs_rest_postprocessing.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "multiclass" / "one_vs_rest_postprocessing" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.multiclass.one_vs_rest_postprocessing.one_vs_rest_binary_predict_threshold",
    "sciona.atoms.ml.sklearn.multiclass.one_vs_rest_postprocessing.one_vs_rest_multilabel_indicator_csc",
    "sciona.atoms.ml.sklearn.multiclass.one_vs_rest_postprocessing.one_vs_rest_positive_probability_matrix",
    "sciona.atoms.ml.sklearn.multiclass.one_vs_rest_postprocessing.one_vs_rest_binary_probability_matrix",
    "sciona.atoms.ml.sklearn.multiclass.one_vs_rest_postprocessing.one_vs_rest_normalized_probability_matrix",
    "sciona.atoms.ml.sklearn.multiclass.one_vs_rest_postprocessing.one_vs_rest_decision_output",
}
...
def test_bundle_exists_and_has_multiclass_one_vs_rest_postprocessing_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_multiclass_one_vs_rest_postprocessing.review_bundle.json"
...
def test_manifest_contains_multiclass_one_vs_rest_postprocessing_atoms_after_merge() -> None:
