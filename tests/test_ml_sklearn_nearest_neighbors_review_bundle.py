...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_nearest_neighbors.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "neighbors" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.neighbors.nearest_neighbors_fit",
    "sciona.atoms.ml.sklearn.neighbors.nearest_neighbors_kneighbors",
    "sciona.atoms.ml.sklearn.neighbors.nearest_neighbors_radius_neighbors",
    "sciona.atoms.ml.sklearn.neighbors.nearest_neighbors_kneighbors_graph",
    "sciona.atoms.ml.sklearn.neighbors.nearest_neighbors_radius_neighbors_graph",
}


def test_nearest_neighbors_review_bundle_exists_and_parses() -> None:
...
def test_nearest_neighbors_review_bundle_rows_are_publishable() -> None:
    bundle = json.loads(BUNDLE_PATH.read_text(encoding="utf-8"))
...
def test_nearest_neighbors_cdg_nodes_have_io_specs() -> None:
...
def test_manifest_contains_nearest_neighbors_atoms_after_merge() -> None:
