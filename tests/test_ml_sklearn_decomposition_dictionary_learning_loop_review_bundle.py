...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_decomposition_dictionary_learning_loop.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "decomposition" / "dictionary_learning_loop" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.decomposition.dictionary_learning_loop.dictionary_learning_callback_due",
    "sciona.atoms.ml.sklearn.decomposition.dictionary_learning_loop.dictionary_learning_converged",
    "sciona.atoms.ml.sklearn.decomposition.dictionary_learning_loop.dictionary_learning_cost",
    "sciona.atoms.ml.sklearn.decomposition.dictionary_learning_loop.dictionary_learning_resize_factors",
    "sciona.atoms.ml.sklearn.decomposition.dictionary_learning_loop.dictionary_learning_svd_initialize",
}
...
def test_bundle_exists_and_has_dictionary_learning_loop_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_decomposition_dictionary_learning_loop.review_bundle.json"
...
def test_manifest_contains_dictionary_learning_loop_atoms_after_merge() -> None:
