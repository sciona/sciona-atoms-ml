...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_manifold_tsne_schedule.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "manifold" / "tsne_schedule" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.manifold.tsne_schedule.tsne_gradient_descent_buffers",
    "sciona.atoms.ml.sklearn.manifold.tsne_schedule.tsne_gradient_descent_compute_error",
    "sciona.atoms.ml.sklearn.manifold.tsne_schedule.tsne_gradient_descent_convergence",
    "sciona.atoms.ml.sklearn.manifold.tsne_schedule.tsne_early_exaggeration_scale",
    "sciona.atoms.ml.sklearn.manifold.tsne_schedule.tsne_early_exaggeration_unscale",
    "sciona.atoms.ml.sklearn.manifold.tsne_schedule.tsne_stage_two_required",
}
...
def test_bundle_exists_and_has_tsne_schedule_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_manifold_tsne_schedule.review_bundle.json"
...
def test_manifest_contains_tsne_schedule_atoms_after_merge() -> None:
