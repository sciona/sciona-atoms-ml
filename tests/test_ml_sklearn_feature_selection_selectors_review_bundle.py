...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_feature_selection_selectors.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "feature_selection" / "selectors" / "cdg.json"
...
def test_bundle_exists_and_has_selector_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_feature_selection_selectors.review_bundle.json"
...
def test_manifest_contains_selector_atoms_after_merge() -> None:
