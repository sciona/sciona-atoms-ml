...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_forest_predict_preflight.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "forest_predict_preflight" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.ensemble.forest_predict_preflight.forest_predict_ensure_all_finite_mode",
    "sciona.atoms.ml.sklearn.ensemble.forest_predict_preflight.forest_predict_require_sparse_int32_indices",
}
...
def test_bundle_exists_and_has_forest_predict_preflight_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_forest_predict_preflight.review_bundle.json"
...
def test_manifest_contains_forest_predict_preflight_atoms_after_merge() -> None:
