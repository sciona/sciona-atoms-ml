...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_decomposition_sparse_encode_preprocessing.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "decomposition" / "sparse_encode_preprocessing" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.decomposition.sparse_encode_preprocessing.sparse_encode_regularization",
    "sciona.atoms.ml.sklearn.decomposition.sparse_encode_preprocessing.sparse_encode_gram",
    "sciona.atoms.ml.sklearn.decomposition.sparse_encode_preprocessing.sparse_encode_covariance",
    "sciona.atoms.ml.sklearn.decomposition.sparse_encode_preprocessing.sparse_encode_threshold",
}
...
def test_bundle_exists_and_has_sparse_encode_preprocessing_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_decomposition_sparse_encode_preprocessing.review_bundle.json"
...
def test_manifest_contains_sparse_encode_preprocessing_atoms_after_merge() -> None:
