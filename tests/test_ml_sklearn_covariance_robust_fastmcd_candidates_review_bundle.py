...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_covariance_robust_fastmcd_candidates.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "covariance" / "robust_fastmcd_candidates" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_candidates.fast_mcd_candidate_pool_from_random_starts",
    "sciona.atoms.ml.sklearn.covariance.robust_fastmcd_candidates.fast_mcd_candidate_pool_from_estimates",
}
...
def test_bundle_exists_and_has_fastmcd_candidates_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_covariance_robust_fastmcd_candidates.review_bundle.json"
...
def test_manifest_contains_fastmcd_candidates_atoms_after_merge() -> None:
