...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_spectral_labeling.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "spectral_labeling" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.cluster.spectral_labeling.spectral_cluster_qr_labels",
    "sciona.atoms.ml.sklearn.cluster.spectral_labeling.spectral_discretize_labels",
}
...
def test_bundle_exists_and_has_spectral_labeling_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_spectral_labeling.review_bundle.json"
...
def test_manifest_contains_spectral_labeling_atoms_after_merge() -> None:
