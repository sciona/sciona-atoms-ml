...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_covariance_covariance_tags.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "covariance" / "covariance_tags" / "cdg.json"
...
def test_bundle_exists_and_has_covariance_tags_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_covariance_covariance_tags.review_bundle.json"
