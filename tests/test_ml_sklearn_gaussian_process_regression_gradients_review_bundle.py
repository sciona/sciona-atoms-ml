...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_gaussian_process_regression_gradients.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "gaussian_process" / "regression_gradients" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.gaussian_process.regression_gradients.gp_log_marginal_gradient",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_gradients.gp_log_marginal_gradient_dims",
    "sciona.atoms.ml.sklearn.gaussian_process.regression_gradients.gp_log_marginal_gradient_inner_term",
}
...
def test_bundle_exists_and_has_gp_regression_gradient_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_gaussian_process_regression_gradients.review_bundle.json"
...
def test_manifest_contains_gp_regression_gradient_atoms_after_merge() -> None:
