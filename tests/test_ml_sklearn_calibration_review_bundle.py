...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_calibration.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "calibration" / "cdg.json"
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_calibration.review_bundle.json"
...
def test_manifest_contains_calibration_curve_after_merge() -> None:
