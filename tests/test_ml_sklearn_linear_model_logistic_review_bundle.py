...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_logistic.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "linear_model" / "logistic" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.linear_model.logistic.binary_logistic_dense_loss_gradient",
    "sciona.atoms.ml.sklearn.linear_model.logistic.binary_logistic_half_loss_gradient",
    "sciona.atoms.ml.sklearn.linear_model.logistic.binary_logistic_positive_probability",
}
...
def test_bundle_exists_and_has_logistic_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_linear_model_logistic.review_bundle.json"
...
def test_manifest_contains_logistic_atoms_after_merge() -> None:
