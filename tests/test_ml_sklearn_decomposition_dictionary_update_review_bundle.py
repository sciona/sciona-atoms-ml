...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_decomposition_dictionary_update.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "decomposition" / "dictionary_update" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.decomposition.dictionary_update.dictionary_learning_sufficient_statistics",
    "sciona.atoms.ml.sklearn.decomposition.dictionary_update.dictionary_learning_active_update",
}
...
def test_bundle_exists_and_has_dictionary_update_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_decomposition_dictionary_update.review_bundle.json"
...
def test_manifest_contains_dictionary_update_atoms_after_merge() -> None:
