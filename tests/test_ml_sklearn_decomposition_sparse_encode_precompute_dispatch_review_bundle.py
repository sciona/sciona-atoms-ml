...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_decomposition_sparse_encode_precompute_dispatch.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "decomposition" / "sparse_encode_precompute_dispatch" / "cdg.json"
...
def test_bundle_exists_and_has_sparse_encode_precompute_dispatch_atoms() -> None:
...
def test_bundle_matches_cdg_family() -> None:
    ...
    assert cdg["module"] == "sciona.atoms.ml.sklearn.decomposition.sparse_encode_precompute_dispatch"
    assert bundle["family_batch"] == "ml_sklearn_decomposition_sparse_encode_precompute_dispatch"
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_decomposition_sparse_encode_precompute_dispatch.review_bundle.json"
