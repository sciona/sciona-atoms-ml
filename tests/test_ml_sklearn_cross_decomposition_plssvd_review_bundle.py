...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cross_decomposition_plssvd.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cross_decomposition" / "cdg.json"
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cross_decomposition_plssvd.review_bundle.json"
...
def test_manifest_contains_plssvd_atom_after_merge() -> None:
