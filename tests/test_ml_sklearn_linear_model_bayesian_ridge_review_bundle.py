...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_linear_model_bayesian_ridge.review_bundle.json"
...
def test_bundle_exists_and_has_bayesian_ridge_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_linear_model_bayesian_ridge.review_bundle.json"
...
def test_manifest_contains_bayesian_ridge_atoms_after_merge() -> None:
