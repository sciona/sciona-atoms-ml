...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_gaussian_process_classification_predict_shell.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "gaussian_process" / "classification_predict_shell" / "cdg.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.gaussian_process.classification_predict_shell.gpc_predict_dtype_name",
    "sciona.atoms.ml.sklearn.gaussian_process.classification_predict_shell.gpc_predict_validate_ensure_2d",
}
...
def test_bundle_exists_and_has_gpc_predict_shell_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_gaussian_process_classification_predict_shell.review_bundle.json"
