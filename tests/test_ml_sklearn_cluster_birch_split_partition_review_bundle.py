...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_birch_split_partition.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "birch_split_partition" / "cdg.json"
...
def test_bundle_exists_and_has_birch_split_partition_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_birch_split_partition.review_bundle.json"
