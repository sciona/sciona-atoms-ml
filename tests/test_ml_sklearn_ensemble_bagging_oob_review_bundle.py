...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_ensemble_bagging_oob.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "ensemble" / "bagging_oob" / "cdg.json"
...
def test_bundle_exists_and_has_bagging_oob_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_ensemble_bagging_oob.review_bundle.json"
...
def test_manifest_contains_bagging_oob_atoms_after_merge() -> None:
