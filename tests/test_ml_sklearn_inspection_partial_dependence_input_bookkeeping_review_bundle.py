...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_inspection_partial_dependence_input_bookkeeping.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "inspection" / "partial_dependence_input_bookkeeping" / "cdg.json"
...
def test_bundle_exists_and_has_partial_dependence_input_bookkeeping_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_inspection_partial_dependence_input_bookkeeping.review_bundle.json"
...
def test_manifest_contains_partial_dependence_input_bookkeeping_atoms_after_merge() -> None:
