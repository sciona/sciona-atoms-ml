...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_impute_iterative_postprocessing.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "impute" / "iterative_postprocessing" / "cdg.json"
MANIFEST_PATH = ROOT / "data" / "audit_manifest.json"

EXPECTED_ATOM_NAMES = {
    "sciona.atoms.ml.sklearn.impute.iterative_postprocessing.iterative_assign_feature_values",
    "sciona.atoms.ml.sklearn.impute.iterative_postprocessing.iterative_clipped_imputed_values",
    "sciona.atoms.ml.sklearn.impute.iterative_postprocessing.iterative_posterior_imputed_values",
    "sciona.atoms.ml.sklearn.impute.iterative_postprocessing.iterative_restore_observed_values",
}
...
def test_bundle_exists_and_has_iterative_postprocessing_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_impute_iterative_postprocessing.review_bundle.json"
...
def test_manifest_contains_iterative_postprocessing_atoms_after_merge() -> None:
