...
BUNDLE_PATH = ROOT / "data" / "review_bundles" / "ml_sklearn_cluster_hdbscan_dbscan_clustering.review_bundle.json"
CDG_PATH = ROOT / "src" / "sciona" / "atoms" / "ml" / "sklearn" / "cluster" / "hdbscan_dbscan_clustering" / "cdg.json"
...
def test_bundle_exists_and_has_hdbscan_dbscan_clustering_atoms() -> None:
...
def test_bundle_level_fields() -> None:
    ...
    assert bundle["review_record_path"] == "data/review_bundles/ml_sklearn_cluster_hdbscan_dbscan_clustering.review_bundle.json"
