"""Sklearn coordinate-descent LassoCV init atoms."""
...
from .witnesses import witness_cd_lasso_cv_super_init_kwargs
...
@register_atom(witness_cd_lasso_cv_super_init_kwargs)
...
@icontract.ensure(
    ...
    "LassoCV super-init kwargs must match sklearn delegation payload",
)
def cd_lasso_cv_super_init_kwargs(
    eps: object,
    n_alphas: int,
    alphas: object,
    fit_intercept: bool,
    ...
    """Return kwargs passed by LassoCV.__init__ into LinearModelCV.__init__."""
    return {
        "eps": eps,
        "n_alphas": n_alphas,
        "alphas": alphas,
